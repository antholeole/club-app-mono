import { GOOGLE_PEM_SRC, GOOGLE_CERTS, GOOGLE_VALID_AUDS, GOOGLE_VALID_ISSUER, DEFAULT_USERNAME } from '../../../../src/constants'
import { getFakeIdentifier, verifyIdTokenWithGoogle } from '../../../../src/routers/auth/register/helpers'
