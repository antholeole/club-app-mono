...
import 'package:fe/pages/groups/features/club_tab/club_tab.dart';
import 'package:fe/pages/groups/features/dm_tab/dm_tab.dart';
import 'package:fe/pages/groups/features/widgets/groups_tab.dart';
    ...
    return SizedBox.expand(
      child: SingleChildScrollView(
        child: GqlOperation<GQuerySelfGroupsData, GQuerySelfGroupsVars>(
          operationRequest: GQuerySelfGroupsReq(
              (q) => q..vars.selfId = context.read<UserCubit>().user.id),
          onResponse: (data) {
            final clubs = [
              ...
              child: Column(
                children: [
                  GroupsTab<Club>(
                    ...
                    groups: clubs,
                    header: 'Your Clubs',
                    onAdd: () => context.read<GroupJoiner>().showPrompt().then(
                        (_) => context
                            .read<
