...
import 'package:fe/gql/insert_new_event.data.gql.dart'
    show GInsertEventData, GInsertEventData_insert_events_one;
import 'package:fe/gql/insert_new_event.req.gql.dart' show GInsertEventReq;
import 'package:fe/gql/insert_new_event.var.gql.dart' show GInsertEventVars;
...
import 'package:fe/schema.schema.gql.dart'
    show
        ...
        Gevents_bool_exp,
        Gevents_constraint,
        Gevents_insert_input,
        Gevents_obj_rel_insert_input,
        Gevents_on_conflict,
        Gevents_order_by,
        Gevents_pk_columns_input,
        Gevents_select_column,
        Gevents_set_input,
        Gevents_update_column,
        ...
        Groles_set_input,
        Groles_to_events_aggregate_order_by,
        Groles_to_events_arr_rel_insert_input,
        Groles_to_events_bool_exp,
        Groles_to_events_constraint,
        Groles_to_events_insert_input,
        Groles_to_events_max_order_by,
        Groles_to_events_min_order_by,
        Groles_to_events_on_conflict,
        Groles_to_events_order_by,
        Groles_to_events_pk_columns_input,
        Groles_to_events_select_column,
        Groles_to_events_set_input,
        Groles_to_events_update_column,
...
@SerializersFor([
  ...
  GIdentityProvider,
  GInsertEventData,
  GInsertEventData_insert_events_one,
  GInsertEventReq,
  GInsertEventVars,
  GInsertMessageData,
  GInsertMessageData_insert_messages,
