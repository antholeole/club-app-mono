...
//export const HASURA_ENDPOINT = ((ENVIRONMENT === 'dev') ? 'localhost:8080/' : 'https://club-app-db.herokuapp.com/v1/') + 'graphql'
export const HASURA_ENDPOINT = 'https://club-app-db.herokuapp.com/v1/graphql'
